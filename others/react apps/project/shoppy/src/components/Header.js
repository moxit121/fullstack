...
const Header = () => {
  ...
  return <header className={`${isActive?"bg-gray-400":" bg-gray-300"} fixed w-full z-10 transition-all p-5 flex justify-center `}>
   ...
   <ul className="flex flex-wrap flex-row p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 mb-4">
        <li>
    ...
    <div className='bg-red-500 absolute right-1 top-3 text-[12px] w-[18px] h-[18px]  text-white rounded-full flex justify-center items-center'>{itemAmount}</div>
    </div>
    </div>
